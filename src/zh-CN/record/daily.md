...
最近一周都没咋更新，在速通人民的名义，今天终于看完了，明天开始回复更新。

## 2025.08.06
开始做正常的版本迭代了，上github的CI/CD，每次发版打tag就会自动部署后端到测试服务器。B站介绍视频也弄了，后续也要开始对一些技术类型的内容做一些记录了。
前端今年年底估计就可以全面替换成rolldown vite了，估计开发和打包体验都会好很多。
现在设计一些功能都会通过kimi或者豆包先帮我设计一下，然后再开始实现。
