...
- [OPAQUE RFC 规范](https://datatracker.ietf.org/doc/rfc9807/)
- [项目使用的 OPAQUE 库](https://github.com/serenity-kit/opaque)
- [库的官方文档](https://opaque-auth.com/)
- [Facebook 的 OPAQUE 实现（Rust）](https://github.com/facebook/opaque-ke)
