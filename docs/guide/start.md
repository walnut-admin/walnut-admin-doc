...
本地环境需要安装[Node.js][node] 和 [Git][git]，npm是node的配套，一般无需特意安装。
...
**推荐等级 A**
- [volar][volar] - Vue3 + ts + vscode 必备插件

**推荐等级 B**
- [Iconify IntelliSense][Iconify IntelliSense] - Icon 实时显示
- [Windicss IntelliSense][Windicss IntelliSense] - windicss的智能提示
- [I18n-ally][I18n-ally] - 国际化实时显示。

**推荐等级 C**
- [ESLint][ESLint] - 脚本代码检查
- [Prettier][Prettier] - 代码格式化
- [Stylelint][Stylelint] - css 格式化(用了windi后好像用处不大了)
